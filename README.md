...
Practical guide to using Pandas for real-world data analysis, focused on railway systems and urban mobility.
...
**raw data → analysis → decision-making**

---

## Why this project

Most Pandas resources focus on syntax.
